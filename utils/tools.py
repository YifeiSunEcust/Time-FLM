...
def validate(args, model, vali_data, vali_loader, criterion, mae_metric):
    ...
    model.eval()
    with torch.no_grad():
        for i, (batch_x, batch_y, batch_x_mark, batch_y_mark, pred_len) in tqdm(enumerate(vali_loader)):
            ...
            with torch.cuda.amp.autocast():
                outputs = model(batch_x, batch_x_mark, batch_y, batch_y_mark, pred_len)
